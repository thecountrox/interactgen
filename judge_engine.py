...
async def evaluate_page(
    ...
    try:
        ...
        ]) if relevant_memories else "No previous interactions found."
...
Return ONLY valid JSON, no additional text."""
        ...
        try:
            ...
            logger.info(f"✓ Judge Engine evaluation complete: {result.get('summary', 'N/A')}")
            return result
...
def create_fallback_response(
    ...
    if technical_level == "beginner":
        ...
        highlight_selectors = ["button[type='submit']", ".primary-button", ".cta-button"]
